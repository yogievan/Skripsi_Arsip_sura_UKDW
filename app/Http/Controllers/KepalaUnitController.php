...
class KepalaUnitController extends Controller
{
    ...
    public function ViewArsipSurat(){
        ...
        return view('kepala_unit.arsip_surat',
        [
    ...
    public function DetailArsipSuratMasuk($id){
        ...
        return view('kepala_unit.detail_arsip_surat_masuk', compact('suratMasuk'),
        [
            'suratMasuk' => $suratMasuk,
            'suratKeluar' => $suratKeluar,
            'users' => $users,
    ...
    public function DetailArsipSuratKeluar($id){
        ...
        return view('kepala_unit.detail_arsip_surat_keluar', compact('suratkeluar'),
        [
            'suratkeluar' => $suratkeluar,
            'users' => $users,
            'unit' => $unit,
    ...
    public function ValidasiDetailArsipSuratMasuk($id, Request $request){
        $suratMasuk = SuratMasuk::find($id);
        $status_surat = "Surat Tervalidasi Kepala Unit";
        $suratMasuk -> status_surat = $status_surat;
        $suratMasuk -> save();
        Alert::toast('Surat Berhasil di Validasi!','success');
        return Redirect::back(); 
    }

    public function ValidasiDetailArsipSuratKeluar($id, Request $request){
        $suratKeluar = SuratKeluar::find($id);
        $status_surat = "Surat Tervalidasi Kepala Unit";
        $suratKeluar -> status_surat = $status_surat;
        $suratKeluar -> save();
        Alert::toast('Surat Berhasil di Validasi!','success');
        return Redirect::back(); 
    }

    public function BatalValidasiDetailArsipSuratMasuk($id, Request $request){
        $suratMasuk = SuratMasuk::find($id);
        $status_surat = "Surat Belum Tervalidasi Kepala Unit";
        $suratMasuk -> status_surat = $status_surat;
        $suratMasuk -> save();
        Alert::toast('Berhasil Tolak Validasi!','success');
        return Redirect::back(); 
    }

    public function BatalValidasiDetailArsipSuratKeluar($id, Request $request){
        $suratKeluar = SuratKeluar::find($id);
        $status_surat = "Surat Belum Tervalidasi Kepala Unit";
        $suratKeluar -> status_surat = $status_surat;
        $suratKeluar -> save();
    ...
    public function ViewEditArsipSuratMasuk($id){
        ...
        $kategori_surat = Kategori::all();
        $unit = Unit::all();
        return view('kepala_unit.edit_arsip_surat_masuk', compact('suratMasuk'),[
            'suratMasuk' => $suratMasuk,
            'kategori_surat' => $kategori_surat,
            'unit' => $unit,
        ]);
    ...
    public function ViewEditArsipSuratKeluar($id){
        ...
        return view('kepala_unit.edit_arsip_surat_keluar', compact('suratKeluar'),[
    ...
    public function EditArsipSuratMasuk($id, Request $request){
        ...
        return redirect(route('ListArsipSuratMasuk_kepalaunit'));
    }
    public function EditArsipSuratKeluar($id, Request $request){
        ...
        $suratKeluar -> unit_penerima = $request -> unit_penerima;
        ...
        return redirect(route('ListArsipSuratKeluar_kepalaunit'));
    }
    ...
    public function DetailArsipDisposisiSuratMasuk($id, $id_surat_masuk){
        ...
        return view('kepala_unit.detail_arsip_disposisi_surat_masuk', compact('disposisiSuratMasuk'),
        [
            'disposisiSuratMasuk' => $disposisiSuratMasuk,
            'suratMasuk' => $suratMasuk,
            'users' => $users,
    ...
    public function DetailArsipDisposisiSuratKeluar($id, $id_surat_keluar){
        ...
        return view('kepala_unit.detail_arsip_disposisi_surat_keluar', compact('disposisiSuratKeluar'),
        [
            'disposisiSuratKeluar' => $disposisiSuratKeluar,
            'suratKeluar' => $suratKeluar,
            'users' => $users,
