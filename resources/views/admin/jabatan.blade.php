...
@section('content')
    <div>
        <div class="grid grid-cols-3 gap-4">
            <div>
                {{-- Tambah kategori --}}
                <button data-modal-target="tambah_jabatan" data-modal-toggle="tambah_jabatan" class="bg-[#006B3F] p-3 rounded text-white font-semibold mt-3 hover:bg-[#018951]">Tambah Kategori Surat</button>
